...
<script type="text/javascript">
	...
	function idChk() {
		...
		if(doc.value.trim() == "" || doc.value == null) {
			...
			open("controller.jsp?command=idchk&id="+doc.value,"","width=200,height=200");
		}
	}
...
<body>
	...
	<form action="controller.jsp" method="post">
		...
		<table border="1">
			...
			<tr>
				<th>비밀번호</th>
				<td><input type="text" name="pw" required="required" onclick="idChkConfirm()"></td>
			</tr>
			<tr>
				<th>이름</th>
			...
			<tr>
				<th>주소</th>
				<td><input type="text" name="addr" required="required" onclick="idChkConfirm()"></td>
			</tr>
			<tr>
				<th>전화번호</th>
			...
			<tr>
				<th>이메일</th>
				<td><input type="text" name="email" required="required" onclick="idChkConfirm()"></td>
			</tr>
			<tr>
				<td>
					<input type="submit" value="회원가입">
					<input type="button" value="취소" onclick="index.jsp">
				</td>
			</tr>
		</table>
	</form>
